...
public class Button extends View {
    ...
    public Button(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray attributes = context.obtainStyledAttributes(attrs, R.styleable.Button);
        mColor = attributes.getColor(R.styleable.Button_paper_color,
                getResources().getColor(R.color.paper_button_color));
        mShadowColor = attributes.getColor(R.styleable.Button_paper_shadow_color,
                getResources().getColor(R.color.paper_button_shadow_color));
        mCornerRadius = attributes.getDimensionPixelSize(R.styleable.Button_paper_corner_radius,
                getResources().getDimensionPixelSize(R.dimen.paper_button_corner_radius));
        mText = attributes.getText(R.styleable.Button_paper_text);
        mTextSize = attributes.getDimensionPixelSize(R.styleable.Button_paper_text_size,
                getResources().getDimensionPixelSize(R.dimen.paper_text_size));
        mTextColor = attributes.getColor(R.styleable.Button_paper_text_color,
                getResources().getColor(R.color.paper_text_color));
        final String assetPath = attributes.getString(R.styleable.Button_paper_font);
        if (assetPath != null) {
            AssetManager assets = context.getAssets();
            Typeface typeface = Typeface.createFromAsset(assets, assetPath);
            textPaint.setTypeface(typeface);
        }
        mShadowRadius = attributes.getFloat(R.styleable.Button_paper_shadow_radius, SHADOW_RADIUS);
        mShadowOffsetX = attributes.getFloat(R.styleable.Button_paper_shadow_offset_x, SHADOW_OFFSET_X);
        mShadowOffsetY = attributes.getFloat(R.styleable.Button_paper_shadow_offset_y, SHADOW_OFFSET_Y);
        attributes.recycle();
