...
public class StPNotif extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        new getNotif().execute(MyApplication.host_add + "students/" + sp.getString(MyApplication.svreg, "") + "/notif.json?q=" + a);
        return rootView;
    }
    ...
    class getNotif extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            if (s.charAt(0) != '[' && getActivity() != null) {
                ...
                card.setTitleColor(getResources().getColor(R.color.accent2));
                mListView.add(card);
                ...
                try {
                    ...
                    for (int i = ja.length() - 1; i >= 0; --i) {
                        if (getActivity() != null) {
                            ...
                            card.setTitleColor(getResources().getColor(R.color.secondary_text));
                            card.setDescriptionColor(getResources().getColor(R.color.accent2));
                            mListView.add(card);
                        }
                    }
